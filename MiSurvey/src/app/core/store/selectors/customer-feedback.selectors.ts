...
export const getCustomerFeedbackState =
  createFeatureSelector<CustomerFeedbackState>('feature_customer_feedback');
...
const selectSurveyResponse = (questionId: number) =>
  createSelector(getSurveyResponses, (responses: FeedbackResponse[]) =>
